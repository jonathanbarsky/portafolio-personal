const projectsData = [
    {
        ...
        projectDescription: `Batatabit es una Single Page App cuya UI fue diseñada en figma, sobre lo que me base para realizar esta pagina.
    ...
    },
    {
        ...
        projectDescription: `The movie DB es una Multi Page App que muestra catálogos de películas separadas por categorías, también cuenta con la característica de tener un buscador en que podrás buscar la película que desees, esto gracias al consumo de la API de The Movie DB.
    ...
    },
    {
        ...
        projectDescription: `Space tourism website es un reto de la pagina de Frontend Mentor cuyo diseño saque de figma, en el que me basé para realizar esta pagina.
