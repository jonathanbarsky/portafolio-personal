...
exports.english = exports.spanish = void 0;
var spanish = {
  "nav": {
    "about": "Sobre mi",
    "language": "Idioma",
  ...
  "profile": {
    ...
    "description": "Desarrollador Frontend con s\xF3lidos conocimientos de HTML, CSS, Javacript para el desarrollo de p\xE1ginas web con Responsive Design.\n\n        Mi experiencia desarrollando en el ecosistema de React incluye a react router dom V6, react Hooks, estados de React y adem\xE1s brindarle una mejor legibilidad al c\xF3digo implementando las react props junto con la composici\xF3n de componentes.\n\n        Tengo experiencia: desarrollando proyectos de tipo Single Page App(SPA), Multi Page App(MPA), persistencia de datos, utilizar el preprocesador SASS para los estilos, consumo de APIs REST para hacer p\xE1ginas din\xE1micas, implementar esqueletos de carga con el fin de mejorar la UX y realizar animaciones con CSS puro.\n\n        Soy de argentina y por ahora mi nivel de ingl\xE9s es A2.\n\n    Me apasiona el aprendizaje continuo en tecnolog\xEDas y habilidades que me permitan mejorar la productividad.\n\n    Actualmente soy estudiante en platzi y trabajo para especializarme en el stack de tecnolog\xEDas PERNN."
  },
  "projects": {
    "title": "Proyectos",
